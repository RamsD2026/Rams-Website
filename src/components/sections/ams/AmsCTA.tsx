 ...
 * as the Digital Twin, MEPS, IRDS, RackIQ, ATOS, RTSS and IMDS closes.
 *
  ...
  return (
    ...
    >
      ...
      <div className="relative rams-container text-center pt-32 sm:pt-40 lg:pt-44 pb-32 sm:pb-40 lg:pb-44">
        ...
        >
          <span className="text-white">See the operation directly.</span>
          <br />
          <span className="text-white/45">
            Build <span className="text-signal-orange">intelligence</span> across
            it.
          </span>
        </motion.h2>
        ...
        >
          Connect the sites. Open the Digital Twin. Drill into the asset.
          Analyse across modules. Prioritise the action. Verify the outcome.
        </motion.p>
