  ...
  return (
    ...
    >
      ...
      <div className="relative rams-container text-center pt-32 sm:pt-40 lg:pt-44 pb-32 sm:pb-40 lg:pb-44">
        ...
        >
          <span className="text-white">Make every safety event</span>
          <br />
          <span className="text-white/45">
            visible, explainable and{" "}
            <span className="text-signal-orange">actionable</span>.
          </span>
        </motion.h2>
        ...
        >
          Connect the signals. Detect the event. Add physical context. Alert
          the right team. Verify the response. Learn from every pattern.
        </motion.p>
