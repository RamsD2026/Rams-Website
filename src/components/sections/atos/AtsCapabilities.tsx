 ...
 *
 * There is no ATOS capture in /public and the only registered screens are
 ...
 * Two of the six share a pane, which is honest: constraint-aware planning and
 * priority with dependencies are two readings of the same sequenced plan.
 *
...
const GROUPS: {
  ...
  {
    n: "01",
    group: "Order + demand intake",
    title: "Bring every work source into one queue",
    line: "One visible demand pipeline",
    body: "Combine system orders, manual requests, discrepancy work and event-driven tasks with clear source and due context.",
    node: () => <PanelIngest />,
  },
  {
    n: "02",
    group: "Task templates",
    title: "Turn demand into repeatable work",
    line: "From one order to many controlled tasks",
    body: "Configure task templates, required skills, assets, sequence and dependencies for different operational scenarios.",
    node: () => <PanelStructure t={40} />,
  },
  {
    n: "03",
    group: "Constraint-aware planning",
    title: "Plan against operational reality",
    line: "A plan that understands constraints",
    body: "Consider due times, dock readiness, zones, shifts, qualifications, equipment availability and configured restrictions.",
    node: () => <PanelOrchestrate />,
  },
  {
    n: "04",
    group: "Priority + dependencies",
    title: "Keep critical work moving",
    line: "Priority with an explainable reason",
    body: "Sequence work using SLA, urgency, severity, dependency and operational impact — with visible decision context.",
    node: () => <PanelOrchestrate />,
  },
  {
    n: "05",
    group: "Dynamic route optimisation",
    title: "Reduce avoidable travel and conflict",
    line: "Move work through the facility intelligently",
    body: "Recommend efficient movement paths using task location, facility context and the constraints available to the deployment.",
    node: () => <PanelExecute />,
  },
  {
    n: "06",
    group: "Live exception management",
    title: "Replan when reality changes",
    line: "Every replan remains visible and attributable",
    body: "Use connected events or authorised manual updates to surface impact, update queues and coordinate the response.",
    node: () => <PanelAdapt />,
  },
];
...
export function AtsCapabilities() {
  ...
  return (
    <Section surface="offWhite" id="capabilities" clip={false}>
      <SectionHeader
        ...
        top="Everything required to"
        bottom="Coordinate the next best action."
        size="compact"
        width="wide"
        body="Build a connected execution plan across demand, task logic, resources, routes and operational exceptions."
      />
