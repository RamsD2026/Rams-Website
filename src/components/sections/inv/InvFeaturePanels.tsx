...
const PANELS = [
  {
    ...
    body: "Connect stock with zones, racks, bays and pallet positions so teams can understand exactly where inventory is stored.",
    metricLabel: "Location mapping",
    metricValue: "96%",
    metricPct: 96,
  ...
  },
  {
    ...
    body: "Compare physical inventory with expected records and focus teams on missing, misplaced or excess stock.",
  ...
  {
    eyebrow: "Aging & Exceptions",
    title: "Find the inventory that needs attention first.",
    body: "Surface aging stock, long dwell time and recurring discrepancies before they affect space, working capital or service levels.",
    metricLabel: "Exceptions resolved",
    metricValue: "84%",
    metricPct: 84,
    variant: "dark" as const,
  },
              ...
              >
                ...
                <div className="inline-flex items-center gap-2 mb-5">
                  <span
                    ...
                    style={{
                      background: isOrange ? "#111" : "#FF6A00",
                    }}
                  />
                  <span
                    className="text-[10.5px] font-mono font-semibold tracking-[0.22em] uppercase"
                    style={{
                      color: isOrange ? "rgba(17,17,17,0.85)" : "rgba(255,255,255,0.75)",
                    }}
                  >
                    {p.eyebrow}
                  </span>
