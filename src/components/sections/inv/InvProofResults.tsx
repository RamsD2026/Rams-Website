...
const RESULTS = [
  {
    ...
    body: "Physical counts reconciled against system records with sub-1% variance across every site.",
    company: "CH Robinson",
  },
  {
    value: "$1.2M",
    label: "Working capital freed",
    body: "Aging and slow-moving stock exposure reduced, releasing working capital in the first year of rollout.",
    company: "Kellanova",
  },
  {
    value: "75%",
    label: "Faster cycle counts",
    body: "Guided rack-level verification cut cycle-count time from hours to minutes for warehouse teams.",
    company: "DHL Supply Chain",
  },
  {
    value: "60%",
    label: "Fewer discrepancies",
    body: "Location-level reconciliation removed phantom-stock and misplacement discrepancies at source.",
    company: "Kuehne+Nagel",
  },
  {
    value: "0",
    label: "Reconciliation backlog",
    body: "Continuous reconciliation eliminated the month-end backlog for the operations team across facilities.",
    company: "Toll Group",
  },
  {
    value: "100%",
    label: "Location visibility",
    body: "Every rack, bay and zone digitally identified — a single source of truth for stock location.",
    company: "GXO",
  },
];
...
export function InvProofResults() {
  return (
    ...
    >
      <style>{`
        @property --invproof-shine-angle {
          syntax: '<angle>';
          initial-value: 0deg;
          inherits: false;
        }
        .invproof-card { position: relative; isolation: isolate; }
        .invproof-card::before {
          content: "";
          position: absolute;
          inset: -1px;
        ...
        .invproof-card:hover::before {
          opacity: 1;
          animation: invproof-shine 2.4s linear infinite;
        }
        @keyframes invproof-shine {
          to { --invproof-shine-angle: 360deg; }
        }
        @media (prefers-reduced-motion: reduce) {
          .invproof-card:hover::before { animation: none; }
        }
      `}</style>
      <div className="rams-container">
        <div className="max-w-[900px] mx-auto text-center mb-20 sm:mb-24">
          ...
          >
            ...
            protect accuracy, working capital and reconciliation performance
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {RESULTS.map((r, i) => (
            <motion.article
              ...
              className="invproof-card group relative flex flex-col p-8 sm:p-9 bg-white transition-all duration-300 hover:-translate-y-1"
              style={{
                borderRadius: 12,
