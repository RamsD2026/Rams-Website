 ...
 * The close.
 *
 * Built on MepsCTA and RiqCTA — same dark ground, same bottom glow, same
 * button pair.
 *
  ...
  return (
    ...
    >
      ...
      <div className="relative rams-container text-center pt-32 sm:pt-40 lg:pt-44 pb-32 sm:pb-40 lg:pb-44">
        ...
        >
          <span className="text-white">Understand the risk.</span>
          <br />
          <span className="text-white/45">
            Know what to do <span className="text-signal-orange">next</span>.
          </span>
        </motion.h2>
        ...
        >
          See how RTSS connects MHE driving behaviour, safety events, Digital
          Twin context and optional safety hardware to help teams understand
          what happened, investigate with evidence, identify recurring risk and
