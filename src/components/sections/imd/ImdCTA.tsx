  ...
  return (
    ...
    >
      ...
      <div className="relative rams-container text-center pt-32 sm:pt-40 lg:pt-44 pb-32 sm:pb-40 lg:pb-44">
        ...
        >
          <span className="text-white">Turn every MHE into a</span>
          <br />
          <span className="text-white/45">
            connected,{" "}
            <span className="text-signal-orange">diagnosable asset</span>.
          </span>
        </motion.h2>
        ...
        >
          Connect the equipment. Monitor condition. Prioritise faults.
          Coordinate maintenance. Verify the repair. Preserve the complete
          lifecycle history.
        </motion.p>
