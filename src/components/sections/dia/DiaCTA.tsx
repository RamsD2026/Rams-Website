 ...
 * The close.
 *
 * Same ground, glow and button pair as the other solution closes. The demo
 * link goes to /book-a-demo rather than the document's mailto, which is what
 * every CTA on this site does.
 */

const EASE = [0.22, 1, 0.36, 1] as const;

export function DiaCTA() {
  return (
    <section
      id="contact"
        ...
        <div className="max-w-[1180px] mx-auto text-center">
          ...
          >
            ...
            <span className="text-[11px] font-mono font-semibold tracking-[0.22em] uppercase text-white/70">
              Better visibility. Better maintenance decisions.
            </span>
          </motion.div>
          ...
          >
            <span className="block text-white">Make MHE maintenance</span>
            <span
              className="block"
              style={{
                background:
          ...
          >
            Talk to RAMS Digital about MHE diagnostics, fleet health visibility
            and maintenance intelligence for warehouse operations.
          </motion.p>
