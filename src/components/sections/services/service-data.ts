...
const STRUCTURAL_VERIFICATION: Service = {
  ...
  meta: "Verify warehouse floors, racks, mezzanines, platforms and structural assets through field evidence, load-path analysis, engineering checks and compliance reporting before a load or configuration change.",
  assurances: [
    {
