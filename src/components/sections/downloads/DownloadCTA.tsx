 ...
 *
 * ── It asks what you are evaluating ─────────────────────────────────
 * The source's own close, and the right one for this page: somebody at the
 * bottom of a document library either found the file or did not, and the way
 * to help the second case is to ask what the decision is rather than to list
 * the catalogue again.
 */
      ...
      <div className="relative rams-container text-center pt-32 sm:pt-40 lg:pt-44 pb-32 sm:pb-40 lg:pb-44">
        ...
        >
          ...
          <span className="text-white/45">
            you are <span className="text-signal-orange">evaluating</span>.
          </span>
        </motion.h2>
        ...
        >
          Share the facility type, the operational challenge, the locations and
          the stakeholders. We will point you at the product and technical
