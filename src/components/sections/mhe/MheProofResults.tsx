...
const RESULTS = [
  {
    ...
    body: "Every MHE movement is tracked in real time, cutting the time between incident and intervention by a third.",
    company: "Ryder",
  },
  {
    value: "87%",
  ...
  },
  {
    value: "11%",
    label: "UPH increase",
    body: "Productivity gains across 40+ sites through visibility, coaching and better MHE allocation.",
