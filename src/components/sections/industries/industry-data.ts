...
export const INDUSTRIES: Industry[] = [
  {
    ...
    stack: ["Digital Twin", "IRDS", "MEPS", "IBIS", "ATOS"],
  ...
  },
  {
    ...
    stack: ["Digital Twin", "IBIS", "MEPS", "ATOS", "AIMS"],
  ...
  },
  {
    ...
    stack: ["MEPS", "RTSS", "IBIS", "ATOS", "AI Vision"],
  ...
  },
  {
    ...
    stack: ["Digital Twin", "MEPS", "ATOS", "IBIS", "AIMS"],
  ...
  },
  {
    ...
    stack: ["IBIS", "MEPS", "IMDS", "ATOS", "RTSS"],
  ...
  },
  {
    ...
    stack: ["IRDS", "MEPS", "IBIS", "RTSS", "AIMS"],
  ...
  },
  {
    ...
    stack: ["Digital Twin", "IBIS", "ATOS", "IoT", "AIMS"],
  ...
  },
  {
    ...
    stack: ["Digital Twin", "IRDS", "IBIS", "IoT", "AIMS"],
...
export const LAYERS: { tier: string; title: string; body: string }[] = [
  ...
  {
    tier: "Operate",
    title: "IRDS · MEPS · RTSS · IBIS · IMDS · ATOS",
