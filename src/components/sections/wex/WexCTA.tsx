        ...
        <div className="max-w-[1180px] mx-auto text-center">
          ...
          >
            ...
            <span className="text-[11px] font-mono font-semibold tracking-[0.22em] uppercase text-white/70">
              Execute smarter. Move less. Deliver more.
            </span>
          </motion.div>
          ...
          >
            <span className="block text-white">Make execution visible,</span>
            <span
              className="block"
              style={{
                background:
          ...
          >
            Talk to RAMS Digital about task orchestration, MHE and operator
            coordination, and real-time execution intelligence for your
            warehouse.
          </motion.p>
