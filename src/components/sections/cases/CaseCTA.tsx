 ...
 * Partners and Contact pages'.
 *
 * ── Three buttons, and the third is the platform ────────────────────
 * The source offers a rack audit, a conversation and the platform. The first
 * two go to `/company/contact` — one page, two openings — and the third goes
 * to `/platform/overview`, which exists. A reader who has just read six case
 * studies is as likely to want the product as the sales conversation, and
 * sending them to the contact form for that would be answering a different
 * question.
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative rams-container text-center pt-32 sm:pt-40 lg:pt-44 pb-32 sm:pb-40 lg:pb-44">
        ...
        >
          <span className="text-white">Could your site be</span>
          <br />
          <span className="text-white/45">
            the next <span className="text-signal-orange">case study</span>?
          </span>
        </motion.h2>
        ...
        >
          Start with a rack audit or a digital-twin walkthrough. We will show
          you what we would find — and what we would fix — on your floor.
        </motion.p>
