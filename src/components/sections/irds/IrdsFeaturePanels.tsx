...
const PANELS = [
  ...
  },
  {
    ...
    title: "Focus the team on the racks that matter most.",
    body: "Red, Amber and Green severity ranks each finding so critical actions surface first — before they become incidents or downtime.",
    metricLabel: "Rack health",
    metricValue: "91%",
    metricPct: 91,
    variant: "dark" as const,
  },
    ...
    >
      ...
      <div className="relative rams-container pt-28 sm:pt-36 lg:pt-44 pb-28 sm:pb-36 lg:pb-44">
        <div className="max-w-[900px] mx-auto text-center mb-20 sm:mb-24">
          ...
          >
            <span className="text-white">Inspect the risk.</span> <br />
            <span
              style={{
                background:
