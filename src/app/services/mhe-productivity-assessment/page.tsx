...
const service = SERVICE_BY_SLUG["mhe-productivity-assessment"];

export const metadata: Metadata = {
  title: "MHE Productivity Assessment | RAMS Digital",
  description: service.meta,
};

/**
 * /services/mhe-productivity-assessment
 *
 ...
 */
export default function MheProductivityPage() {
